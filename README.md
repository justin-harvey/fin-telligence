...
| [`fintelligence/lseg.html`](fintelligence/lseg.html) | **The LSEG fundamentals demo**, live at [fin-telligence.netlify.app/lseg](https://fin-telligence.netlify.app/lseg) — company financials by real `TR.*` field codes (validated via lseg-mcp), reconciled to their components and attested; synthetic values, credential-swap to real data. |
